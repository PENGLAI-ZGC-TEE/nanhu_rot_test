...
#define KEYMGR_CFG_REGWEN_REG_RESVAL 0x1u
...
#define KEYMGR_CONTROL_SHADOWED_REG_RESVAL 0x10u
#define KEYMGR_CONTROL_SHADOWED_OPERATION_MASK 0x7u
...
#define KEYMGR_SIDELOAD_CLEAR_REG_RESVAL 0x0u
#define KEYMGR_SIDELOAD_CLEAR_VAL_MASK 0x7u
...
#define KEYMGR_RESEED_INTERVAL_REGWEN_REG_RESVAL 0x1u
...
#define KEYMGR_RESEED_INTERVAL_SHADOWED_REG_RESVAL 0x100u
#define KEYMGR_RESEED_INTERVAL_SHADOWED_VAL_MASK 0xffffu
...
#define KEYMGR_SW_BINDING_REGWEN_REG_RESVAL 0x1u
...
#define KEYMGR_SEALING_SW_BINDING_0_REG_RESVAL 0x0u

// Software binding input to sealing portion of the key manager.
#define KEYMGR_SEALING_SW_BINDING_1_REG_OFFSET 0x30
#define KEYMGR_SEALING_SW_BINDING_1_REG_RESVAL 0x0u

// Software binding input to sealing portion of the key manager.
#define KEYMGR_SEALING_SW_BINDING_2_REG_OFFSET 0x34
#define KEYMGR_SEALING_SW_BINDING_2_REG_RESVAL 0x0u

// Software binding input to sealing portion of the key manager.
#define KEYMGR_SEALING_SW_BINDING_3_REG_OFFSET 0x38
#define KEYMGR_SEALING_SW_BINDING_3_REG_RESVAL 0x0u

// Software binding input to sealing portion of the key manager.
#define KEYMGR_SEALING_SW_BINDING_4_REG_OFFSET 0x3c
#define KEYMGR_SEALING_SW_BINDING_4_REG_RESVAL 0x0u

// Software binding input to sealing portion of the key manager.
#define KEYMGR_SEALING_SW_BINDING_5_REG_OFFSET 0x40
#define KEYMGR_SEALING_SW_BINDING_5_REG_RESVAL 0x0u

// Software binding input to sealing portion of the key manager.
#define KEYMGR_SEALING_SW_BINDING_6_REG_OFFSET 0x44
#define KEYMGR_SEALING_SW_BINDING_6_REG_RESVAL 0x0u

// Software binding input to sealing portion of the key manager.
#define KEYMGR_SEALING_SW_BINDING_7_REG_OFFSET 0x48
#define KEYMGR_SEALING_SW_BINDING_7_REG_RESVAL 0x0u
...
#define KEYMGR_ATTEST_SW_BINDING_0_REG_RESVAL 0x0u

// Software binding input to the attestation portion of the key manager.
#define KEYMGR_ATTEST_SW_BINDING_1_REG_OFFSET 0x50
#define KEYMGR_ATTEST_SW_BINDING_1_REG_RESVAL 0x0u

// Software binding input to the attestation portion of the key manager.
#define KEYMGR_ATTEST_SW_BINDING_2_REG_OFFSET 0x54
#define KEYMGR_ATTEST_SW_BINDING_2_REG_RESVAL 0x0u

// Software binding input to the attestation portion of the key manager.
#define KEYMGR_ATTEST_SW_BINDING_3_REG_OFFSET 0x58
#define KEYMGR_ATTEST_SW_BINDING_3_REG_RESVAL 0x0u

// Software binding input to the attestation portion of the key manager.
#define KEYMGR_ATTEST_SW_BINDING_4_REG_OFFSET 0x5c
#define KEYMGR_ATTEST_SW_BINDING_4_REG_RESVAL 0x0u

// Software binding input to the attestation portion of the key manager.
#define KEYMGR_ATTEST_SW_BINDING_5_REG_OFFSET 0x60
#define KEYMGR_ATTEST_SW_BINDING_5_REG_RESVAL 0x0u

// Software binding input to the attestation portion of the key manager.
#define KEYMGR_ATTEST_SW_BINDING_6_REG_OFFSET 0x64
#define KEYMGR_ATTEST_SW_BINDING_6_REG_RESVAL 0x0u

// Software binding input to the attestation portion of the key manager.
#define KEYMGR_ATTEST_SW_BINDING_7_REG_OFFSET 0x68
#define KEYMGR_ATTEST_SW_BINDING_7_REG_RESVAL 0x0u
...
#define KEYMGR_SALT_0_REG_RESVAL 0x0u

// Salt value used as part of output generation
#define KEYMGR_SALT_1_REG_OFFSET 0x70
#define KEYMGR_SALT_1_REG_RESVAL 0x0u

// Salt value used as part of output generation
#define KEYMGR_SALT_2_REG_OFFSET 0x74
#define KEYMGR_SALT_2_REG_RESVAL 0x0u

// Salt value used as part of output generation
#define KEYMGR_SALT_3_REG_OFFSET 0x78
#define KEYMGR_SALT_3_REG_RESVAL 0x0u

// Salt value used as part of output generation
#define KEYMGR_SALT_4_REG_OFFSET 0x7c
#define KEYMGR_SALT_4_REG_RESVAL 0x0u

// Salt value used as part of output generation
#define KEYMGR_SALT_5_REG_OFFSET 0x80
#define KEYMGR_SALT_5_REG_RESVAL 0x0u

// Salt value used as part of output generation
#define KEYMGR_SALT_6_REG_OFFSET 0x84
#define KEYMGR_SALT_6_REG_RESVAL 0x0u

// Salt value used as part of output generation
#define KEYMGR_SALT_7_REG_OFFSET 0x88
#define KEYMGR_SALT_7_REG_RESVAL 0x0u
...
#define KEYMGR_MAX_CREATOR_KEY_VER_SHADOWED_REG_RESVAL 0x0u

// Register write enable for MAX_OWNER_INT_KEY_VERSION
#define KEYMGR_MAX_OWNER_INT_KEY_VER_REGWEN_REG_OFFSET 0x98
#define KEYMGR_MAX_OWNER_INT_KEY_VER_REGWEN_REG_RESVAL 0x1u
...
#define KEYMGR_MAX_OWNER_INT_KEY_VER_SHADOWED_REG_RESVAL 0x1u

// Register write enable for MAX_OWNER_KEY_VERSION
#define KEYMGR_MAX_OWNER_KEY_VER_REGWEN_REG_OFFSET 0xa0
#define KEYMGR_MAX_OWNER_KEY_VER_REGWEN_REG_RESVAL 0x1u
...
#define KEYMGR_MAX_OWNER_KEY_VER_SHADOWED_REG_RESVAL 0x0u
...
#define KEYMGR_SW_SHARE0_OUTPUT_0_REG_RESVAL 0x0u

// Key manager software output.
#define KEYMGR_SW_SHARE0_OUTPUT_1_REG_OFFSET 0xac
#define KEYMGR_SW_SHARE0_OUTPUT_1_REG_RESVAL 0x0u

// Key manager software output.
#define KEYMGR_SW_SHARE0_OUTPUT_2_REG_OFFSET 0xb0
#define KEYMGR_SW_SHARE0_OUTPUT_2_REG_RESVAL 0x0u

// Key manager software output.
#define KEYMGR_SW_SHARE0_OUTPUT_3_REG_OFFSET 0xb4
#define KEYMGR_SW_SHARE0_OUTPUT_3_REG_RESVAL 0x0u

// Key manager software output.
#define KEYMGR_SW_SHARE0_OUTPUT_4_REG_OFFSET 0xb8
#define KEYMGR_SW_SHARE0_OUTPUT_4_REG_RESVAL 0x0u

// Key manager software output.
#define KEYMGR_SW_SHARE0_OUTPUT_5_REG_OFFSET 0xbc
#define KEYMGR_SW_SHARE0_OUTPUT_5_REG_RESVAL 0x0u

// Key manager software output.
#define KEYMGR_SW_SHARE0_OUTPUT_6_REG_OFFSET 0xc0
#define KEYMGR_SW_SHARE0_OUTPUT_6_REG_RESVAL 0x0u

// Key manager software output.
#define KEYMGR_SW_SHARE0_OUTPUT_7_REG_OFFSET 0xc4
#define KEYMGR_SW_SHARE0_OUTPUT_7_REG_RESVAL 0x0u
...
#define KEYMGR_SW_SHARE1_OUTPUT_0_REG_RESVAL 0x0u

// Key manager software output.
#define KEYMGR_SW_SHARE1_OUTPUT_1_REG_OFFSET 0xcc
#define KEYMGR_SW_SHARE1_OUTPUT_1_REG_RESVAL 0x0u

// Key manager software output.
#define KEYMGR_SW_SHARE1_OUTPUT_2_REG_OFFSET 0xd0
#define KEYMGR_SW_SHARE1_OUTPUT_2_REG_RESVAL 0x0u

// Key manager software output.
#define KEYMGR_SW_SHARE1_OUTPUT_3_REG_OFFSET 0xd4
#define KEYMGR_SW_SHARE1_OUTPUT_3_REG_RESVAL 0x0u

// Key manager software output.
#define KEYMGR_SW_SHARE1_OUTPUT_4_REG_OFFSET 0xd8
#define KEYMGR_SW_SHARE1_OUTPUT_4_REG_RESVAL 0x0u

// Key manager software output.
#define KEYMGR_SW_SHARE1_OUTPUT_5_REG_OFFSET 0xdc
#define KEYMGR_SW_SHARE1_OUTPUT_5_REG_RESVAL 0x0u

// Key manager software output.
#define KEYMGR_SW_SHARE1_OUTPUT_6_REG_OFFSET 0xe0
#define KEYMGR_SW_SHARE1_OUTPUT_6_REG_RESVAL 0x0u

// Key manager software output.
#define KEYMGR_SW_SHARE1_OUTPUT_7_REG_OFFSET 0xe4
#define KEYMGR_SW_SHARE1_OUTPUT_7_REG_RESVAL 0x0u

// Key manager working state.
#define KEYMGR_WORKING_STATE_REG_OFFSET 0xe8
#define KEYMGR_WORKING_STATE_REG_RESVAL 0x0u
#define KEYMGR_WORKING_STATE_STATE_MASK 0x7u
...
#define KEYMGR_OP_STATUS_REG_RESVAL 0x0u
#define KEYMGR_OP_STATUS_STATUS_MASK 0x3u
...
#define KEYMGR_ERR_CODE_REG_RESVAL 0x0u
...
#define KEYMGR_FAULT_STATUS_REG_RESVAL 0x0u
...
#define KEYMGR_DEBUG_REG_RESVAL 0x0u
