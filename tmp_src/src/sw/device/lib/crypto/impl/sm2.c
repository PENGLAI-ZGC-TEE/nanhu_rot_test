...
crypto_status_t otcrypto_ecdsa_keygen(const ecc_curve_t *elliptic_curve,
  ...
  LOG_INFO("otcrypto_ecdsa_keygen_async_start");
...
static status_t internal_ecdsa_p256_keygen_finalize(
  ...
  LOG_INFO("internal_ecdsa_p256_keygen_finalize");
  ...
  LOG_INFO("ecdsa_p256_keygen_finalize");
...
crypto_status_t otcrypto_ecdsa_keygen_async_finalize(
  ...
  LOG_INFO("otcrypto_ecdsa_keygen_async_finalize");
...
static status_t internal_ecdsa_p256_sign_start(
  ...
  LOG_INFO("internal_ecdsa_p256_sign_start");
  ...
  // hmac_sha256_init();
  hmac_ctx_t hmac_ctx;
  hmac_init(&hmac_ctx, kHmacModeSha256, /*hmac_key=*/NULL,
                             /*key_wordlen=*/0);
  hmac_update(&hmac_ctx, input_message.data, input_message.len);
  LOG_INFO("hmac1");
  // hmac_update(input_message.data, input_message.len);
  // LOG_INFO("hmac2");
  otcrypto_hash_digest_t digest;
  
  hmac_final(&hmac_ctx, digest.data, digest.len);
  LOG_INFO("hmac");
...
crypto_status_t otcrypto_ecdsa_sign_async_start(
  ...
  LOG_INFO("otcrypto_ecdsa_sign_async_start");
...
crypto_status_t otcrypto_ecdsa_sign_async_finalize(
  ...
  LOG_INFO("otcrypto_ecdsa_sign_async_finalize");
