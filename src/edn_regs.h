...
#define EDN_SW_CMD_STS_CMD_STS_FIELD \
  ((bitfield_field32_t) { .mask = EDN_SW_CMD_STS_CMD_STS_MASK, .index = EDN_SW_CMD_STS_CMD_STS_OFFSET })
...
#define EDN_HW_CMD_STS_CMD_TYPE_FIELD \
  ((bitfield_field32_t) { .mask = EDN_HW_CMD_STS_CMD_TYPE_MASK, .index = EDN_HW_CMD_STS_CMD_TYPE_OFFSET })
#define EDN_HW_CMD_STS_CMD_ACK_BIT 6
#define EDN_HW_CMD_STS_CMD_STS_MASK 0x7u
#define EDN_HW_CMD_STS_CMD_STS_OFFSET 7
#define EDN_HW_CMD_STS_CMD_STS_FIELD \
  ((bitfield_field32_t) { .mask = EDN_HW_CMD_STS_CMD_STS_MASK, .index = EDN_HW_CMD_STS_CMD_STS_OFFSET })
