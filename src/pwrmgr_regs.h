...
// Vector index for adc_ctrl_aon wkup_req, applies for WAKEUP_EN, WAKE_STATUS
// and WAKE_INFO
...
// Vector index for sensor_ctrl_aon wkup_req, applies for WAKEUP_EN,
// WAKE_STATUS and WAKE_INFO
#define PWRMGR_PARAM_SENSOR_CTRL_AON_WKUP_REQ_IDX 5
...
#define PWRMGR_CTRL_CFG_REGWEN_REG_RESVAL 0x1u
#define PWRMGR_CTRL_CFG_REGWEN_EN_BIT 0

// Control register
#define PWRMGR_CONTROL_REG_OFFSET 0x14
#define PWRMGR_CONTROL_REG_RESVAL 0x180u
#define PWRMGR_CONTROL_LOW_POWER_HINT_BIT 0
#define PWRMGR_CONTROL_LOW_POWER_HINT_VALUE_NONE 0x0
#define PWRMGR_CONTROL_LOW_POWER_HINT_VALUE_LOW_POWER 0x1
#define PWRMGR_CONTROL_CORE_CLK_EN_BIT 4
#define PWRMGR_CONTROL_CORE_CLK_EN_VALUE_DISABLED 0x0
#define PWRMGR_CONTROL_CORE_CLK_EN_VALUE_ENABLED 0x1
#define PWRMGR_CONTROL_IO_CLK_EN_BIT 5
#define PWRMGR_CONTROL_IO_CLK_EN_VALUE_DISABLED 0x0
#define PWRMGR_CONTROL_IO_CLK_EN_VALUE_ENABLED 0x1
#define PWRMGR_CONTROL_USB_CLK_EN_LP_BIT 6
#define PWRMGR_CONTROL_USB_CLK_EN_LP_VALUE_DISABLED 0x0
#define PWRMGR_CONTROL_USB_CLK_EN_LP_VALUE_ENABLED 0x1
#define PWRMGR_CONTROL_USB_CLK_EN_ACTIVE_BIT 7
#define PWRMGR_CONTROL_USB_CLK_EN_ACTIVE_VALUE_DISABLED 0x0
#define PWRMGR_CONTROL_USB_CLK_EN_ACTIVE_VALUE_ENABLED 0x1
#define PWRMGR_CONTROL_MAIN_PD_N_BIT 8
#define PWRMGR_CONTROL_MAIN_PD_N_VALUE_POWER_DOWN 0x0
#define PWRMGR_CONTROL_MAIN_PD_N_VALUE_POWER_UP 0x1

// The configuration registers CONTROL, WAKEUP_EN, RESET_EN are all written
// in the
#define PWRMGR_CFG_CDC_SYNC_REG_OFFSET 0x18
#define PWRMGR_CFG_CDC_SYNC_REG_RESVAL 0x0u
...
#define PWRMGR_WAKEUP_EN_REGWEN_REG_RESVAL 0x1u
...
#define PWRMGR_WAKEUP_EN_REG_RESVAL 0x0u
...
#define PWRMGR_WAKEUP_EN_EN_4_BIT 4
#define PWRMGR_WAKEUP_EN_EN_5_BIT 5
...
#define PWRMGR_WAKE_STATUS_REG_RESVAL 0x0u
...
#define PWRMGR_WAKE_STATUS_VAL_4_BIT 4
#define PWRMGR_WAKE_STATUS_VAL_5_BIT 5

// Configuration enable for reset_en register
#define PWRMGR_RESET_EN_REGWEN_REG_OFFSET 0x28
#define PWRMGR_RESET_EN_REGWEN_REG_RESVAL 0x1u
...
#define PWRMGR_RESET_EN_REG_RESVAL 0x0u
...
#define PWRMGR_RESET_STATUS_REG_RESVAL 0x0u
...
#define PWRMGR_ESCALATE_RESET_STATUS_REG_RESVAL 0x0u
...
#define PWRMGR_WAKE_INFO_CAPTURE_DIS_REG_RESVAL 0x0u
#define PWRMGR_WAKE_INFO_CAPTURE_DIS_VAL_BIT 0

// Indicates which functions caused the chip to wakeup.
#define PWRMGR_WAKE_INFO_REG_OFFSET 0x3c
#define PWRMGR_WAKE_INFO_REG_RESVAL 0x0u
#define PWRMGR_WAKE_INFO_REASONS_MASK 0x3fu
...
#define PWRMGR_WAKE_INFO_FALL_THROUGH_BIT 6
#define PWRMGR_WAKE_INFO_ABORT_BIT 7

// A read only register that shows the existing faults
#define PWRMGR_FAULT_STATUS_REG_OFFSET 0x40
#define PWRMGR_FAULT_STATUS_REG_RESVAL 0x0u
