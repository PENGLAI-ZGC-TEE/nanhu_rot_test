...
// Number of keys that can trigger interrupts
#define SYSRST_CTRL_PARAM_NUM_KEY_INTR 7
...
#define SYSRST_CTRL_REGWEN_REG_RESVAL 0x1u
#define SYSRST_CTRL_REGWEN_WRITE_EN_BIT 0

// EC reset control register
#define SYSRST_CTRL_EC_RST_CTL_REG_OFFSET 0x14
#define SYSRST_CTRL_EC_RST_CTL_REG_RESVAL 0x7d0u
#define SYSRST_CTRL_EC_RST_CTL_EC_RST_PULSE_MASK 0xffffu
...
#define SYSRST_CTRL_ULP_AC_DEBOUNCE_CTL_REG_RESVAL 0x1f40u
#define SYSRST_CTRL_ULP_AC_DEBOUNCE_CTL_ULP_AC_DEBOUNCE_TIMER_MASK 0xffffu
...
#define SYSRST_CTRL_ULP_LID_DEBOUNCE_CTL_REG_RESVAL 0x1f40u
#define SYSRST_CTRL_ULP_LID_DEBOUNCE_CTL_ULP_LID_DEBOUNCE_TIMER_MASK 0xffffu
...
#define SYSRST_CTRL_ULP_PWRB_DEBOUNCE_CTL_REG_RESVAL 0x1f40u
#define SYSRST_CTRL_ULP_PWRB_DEBOUNCE_CTL_ULP_PWRB_DEBOUNCE_TIMER_MASK 0xffffu
...
#define SYSRST_CTRL_KEY_INVERT_CTL_REG_RESVAL 0x0u
...
#define SYSRST_CTRL_PIN_ALLOWED_CTL_REG_RESVAL 0x82u
...
#define SYSRST_CTRL_PIN_OUT_CTL_REG_RESVAL 0x82u
...
#define SYSRST_CTRL_PIN_OUT_VALUE_REG_RESVAL 0x0u
...
#define SYSRST_CTRL_PIN_IN_VALUE_REG_RESVAL 0x0u
...
#define SYSRST_CTRL_KEY_INTR_CTL_REG_RESVAL 0x0u
...
#define SYSRST_CTRL_KEY_INTR_DEBOUNCE_CTL_REG_RESVAL 0x7d0u
#define SYSRST_CTRL_KEY_INTR_DEBOUNCE_CTL_DEBOUNCE_TIMER_MASK 0xffffu
...
#define SYSRST_CTRL_AUTO_BLOCK_DEBOUNCE_CTL_REG_RESVAL 0x7d0u
#define SYSRST_CTRL_AUTO_BLOCK_DEBOUNCE_CTL_DEBOUNCE_TIMER_MASK 0xffffu
...
#define SYSRST_CTRL_AUTO_BLOCK_OUT_CTL_REG_RESVAL 0x0u
...
#define SYSRST_CTRL_COM_PRE_SEL_CTL_KEY0_IN_SEL_FIELD_WIDTH 1
#define SYSRST_CTRL_COM_PRE_SEL_CTL_KEY1_IN_SEL_FIELD_WIDTH 1
#define SYSRST_CTRL_COM_PRE_SEL_CTL_KEY2_IN_SEL_FIELD_WIDTH 1
#define SYSRST_CTRL_COM_PRE_SEL_CTL_PWRB_IN_SEL_FIELD_WIDTH 1
#define SYSRST_CTRL_COM_PRE_SEL_CTL_AC_PRESENT_SEL_FIELD_WIDTH 1
#define SYSRST_CTRL_COM_PRE_SEL_CTL_MULTIREG_COUNT 4

// To define the keys that define the pre-condition of the combo
#define SYSRST_CTRL_COM_PRE_SEL_CTL_0_REG_OFFSET 0x54
#define SYSRST_CTRL_COM_PRE_SEL_CTL_0_REG_RESVAL 0x0u
#define SYSRST_CTRL_COM_PRE_SEL_CTL_0_KEY0_IN_SEL_0_BIT 0
#define SYSRST_CTRL_COM_PRE_SEL_CTL_0_KEY1_IN_SEL_0_BIT 1
#define SYSRST_CTRL_COM_PRE_SEL_CTL_0_KEY2_IN_SEL_0_BIT 2
#define SYSRST_CTRL_COM_PRE_SEL_CTL_0_PWRB_IN_SEL_0_BIT 3
#define SYSRST_CTRL_COM_PRE_SEL_CTL_0_AC_PRESENT_SEL_0_BIT 4

// To define the keys that define the pre-condition of the combo
#define SYSRST_CTRL_COM_PRE_SEL_CTL_1_REG_OFFSET 0x58
#define SYSRST_CTRL_COM_PRE_SEL_CTL_1_REG_RESVAL 0x0u
#define SYSRST_CTRL_COM_PRE_SEL_CTL_1_KEY0_IN_SEL_1_BIT 0
#define SYSRST_CTRL_COM_PRE_SEL_CTL_1_KEY1_IN_SEL_1_BIT 1
#define SYSRST_CTRL_COM_PRE_SEL_CTL_1_KEY2_IN_SEL_1_BIT 2
#define SYSRST_CTRL_COM_PRE_SEL_CTL_1_PWRB_IN_SEL_1_BIT 3
#define SYSRST_CTRL_COM_PRE_SEL_CTL_1_AC_PRESENT_SEL_1_BIT 4

// To define the keys that define the pre-condition of the combo
#define SYSRST_CTRL_COM_PRE_SEL_CTL_2_REG_OFFSET 0x5c
#define SYSRST_CTRL_COM_PRE_SEL_CTL_2_REG_RESVAL 0x0u
#define SYSRST_CTRL_COM_PRE_SEL_CTL_2_KEY0_IN_SEL_2_BIT 0
#define SYSRST_CTRL_COM_PRE_SEL_CTL_2_KEY1_IN_SEL_2_BIT 1
#define SYSRST_CTRL_COM_PRE_SEL_CTL_2_KEY2_IN_SEL_2_BIT 2
#define SYSRST_CTRL_COM_PRE_SEL_CTL_2_PWRB_IN_SEL_2_BIT 3
#define SYSRST_CTRL_COM_PRE_SEL_CTL_2_AC_PRESENT_SEL_2_BIT 4

// To define the keys that define the pre-condition of the combo
#define SYSRST_CTRL_COM_PRE_SEL_CTL_3_REG_OFFSET 0x60
#define SYSRST_CTRL_COM_PRE_SEL_CTL_3_REG_RESVAL 0x0u
#define SYSRST_CTRL_COM_PRE_SEL_CTL_3_KEY0_IN_SEL_3_BIT 0
#define SYSRST_CTRL_COM_PRE_SEL_CTL_3_KEY1_IN_SEL_3_BIT 1
#define SYSRST_CTRL_COM_PRE_SEL_CTL_3_KEY2_IN_SEL_3_BIT 2
#define SYSRST_CTRL_COM_PRE_SEL_CTL_3_PWRB_IN_SEL_3_BIT 3
#define SYSRST_CTRL_COM_PRE_SEL_CTL_3_AC_PRESENT_SEL_3_BIT 4

// To define the duration that the combo pre-condition should be pressed
#define SYSRST_CTRL_COM_PRE_DET_CTL_PRECONDITION_TIMER_FIELD_WIDTH 32
#define SYSRST_CTRL_COM_PRE_DET_CTL_MULTIREG_COUNT 4

// To define the duration that the combo pre-condition should be pressed
#define SYSRST_CTRL_COM_PRE_DET_CTL_0_REG_OFFSET 0x64
#define SYSRST_CTRL_COM_PRE_DET_CTL_0_REG_RESVAL 0x0u

// To define the duration that the combo pre-condition should be pressed
#define SYSRST_CTRL_COM_PRE_DET_CTL_1_REG_OFFSET 0x68
#define SYSRST_CTRL_COM_PRE_DET_CTL_1_REG_RESVAL 0x0u

// To define the duration that the combo pre-condition should be pressed
#define SYSRST_CTRL_COM_PRE_DET_CTL_2_REG_OFFSET 0x6c
#define SYSRST_CTRL_COM_PRE_DET_CTL_2_REG_RESVAL 0x0u

// To define the duration that the combo pre-condition should be pressed
#define SYSRST_CTRL_COM_PRE_DET_CTL_3_REG_OFFSET 0x70
#define SYSRST_CTRL_COM_PRE_DET_CTL_3_REG_RESVAL 0x0u
...
// To define the keys that trigger the combo
#define SYSRST_CTRL_COM_SEL_CTL_0_REG_OFFSET 0x74
#define SYSRST_CTRL_COM_SEL_CTL_0_REG_RESVAL 0x0u
...
// To define the keys that trigger the combo
#define SYSRST_CTRL_COM_SEL_CTL_1_REG_OFFSET 0x78
#define SYSRST_CTRL_COM_SEL_CTL_1_REG_RESVAL 0x0u
...
// To define the keys that trigger the combo
#define SYSRST_CTRL_COM_SEL_CTL_2_REG_OFFSET 0x7c
#define SYSRST_CTRL_COM_SEL_CTL_2_REG_RESVAL 0x0u
...
// To define the keys that trigger the combo
#define SYSRST_CTRL_COM_SEL_CTL_3_REG_OFFSET 0x80
#define SYSRST_CTRL_COM_SEL_CTL_3_REG_RESVAL 0x0u
...
// To define the duration that the combo should be pressed
#define SYSRST_CTRL_COM_DET_CTL_0_REG_OFFSET 0x84
#define SYSRST_CTRL_COM_DET_CTL_0_REG_RESVAL 0x0u

// To define the duration that the combo should be pressed
#define SYSRST_CTRL_COM_DET_CTL_1_REG_OFFSET 0x88
#define SYSRST_CTRL_COM_DET_CTL_1_REG_RESVAL 0x0u

// To define the duration that the combo should be pressed
#define SYSRST_CTRL_COM_DET_CTL_2_REG_OFFSET 0x8c
#define SYSRST_CTRL_COM_DET_CTL_2_REG_RESVAL 0x0u

// To define the duration that the combo should be pressed
#define SYSRST_CTRL_COM_DET_CTL_3_REG_OFFSET 0x90
#define SYSRST_CTRL_COM_DET_CTL_3_REG_RESVAL 0x0u
...
// To define the actions once the combo is detected
#define SYSRST_CTRL_COM_OUT_CTL_0_REG_OFFSET 0x94
#define SYSRST_CTRL_COM_OUT_CTL_0_REG_RESVAL 0x0u
...
// To define the actions once the combo is detected
#define SYSRST_CTRL_COM_OUT_CTL_1_REG_OFFSET 0x98
#define SYSRST_CTRL_COM_OUT_CTL_1_REG_RESVAL 0x0u
...
// To define the actions once the combo is detected
#define SYSRST_CTRL_COM_OUT_CTL_2_REG_OFFSET 0x9c
#define SYSRST_CTRL_COM_OUT_CTL_2_REG_RESVAL 0x0u
...
// To define the actions once the combo is detected
#define SYSRST_CTRL_COM_OUT_CTL_3_REG_OFFSET 0xa0
#define SYSRST_CTRL_COM_OUT_CTL_3_REG_RESVAL 0x0u
...
#define SYSRST_CTRL_COMBO_INTR_STATUS_REG_OFFSET 0xa4
#define SYSRST_CTRL_COMBO_INTR_STATUS_REG_RESVAL 0x0u
...
#define SYSRST_CTRL_KEY_INTR_STATUS_REG_OFFSET 0xa8
#define SYSRST_CTRL_KEY_INTR_STATUS_REG_RESVAL 0x0u
