...
#define ADC_CTRL_ADC_WAKEUP_CTL_MATCH_EN_FIELD \
  ((bitfield_field32_t) { .mask = ADC_CTRL_ADC_WAKEUP_CTL_MATCH_EN_MASK, .index = ADC_CTRL_ADC_WAKEUP_CTL_MATCH_EN_OFFSET })
...
#define ADC_CTRL_FILTER_STATUS_MATCH_FIELD \
  ((bitfield_field32_t) { .mask = ADC_CTRL_FILTER_STATUS_MATCH_MASK, .index = ADC_CTRL_FILTER_STATUS_MATCH_OFFSET })
...
#define ADC_CTRL_ADC_INTR_CTL_MATCH_EN_FIELD \
  ((bitfield_field32_t) { .mask = ADC_CTRL_ADC_INTR_CTL_MATCH_EN_MASK, .index = ADC_CTRL_ADC_INTR_CTL_MATCH_EN_OFFSET })
...
#define ADC_CTRL_ADC_INTR_STATUS_MATCH_FIELD \
  ((bitfield_field32_t) { .mask = ADC_CTRL_ADC_INTR_STATUS_MATCH_MASK, .index = ADC_CTRL_ADC_INTR_STATUS_MATCH_OFFSET })
...
#define ADC_CTRL_ADC_FSM_STATE_STATE_FIELD \
  ((bitfield_field32_t) { .mask = ADC_CTRL_ADC_FSM_STATE_STATE_MASK, .index = ADC_CTRL_ADC_FSM_STATE_STATE_OFFSET })
