...
// Sram Egress Entries. Word size is 32bit width.
#define SPI_DEVICE_PARAM_SRAM_EGRESS_DEPTH 848

// Sram Ingress Entries. Word size is 32bit width.
#define SPI_DEVICE_PARAM_SRAM_INGRESS_DEPTH 112

// Sram eFlash read buffer offset (from egress buffer start). Word size is
// 32bit width.
#define SPI_DEVICE_PARAM_SRAM_READ_BUFFER_OFFSET 0

// Sram eFlash read buffer entries. Word size is 32bit width.
#define SPI_DEVICE_PARAM_SRAM_READ_BUFFER_DEPTH 512

// Sram mailbox buffer offset (from egress buffer start). Word size is 32bit
// width.
#define SPI_DEVICE_PARAM_SRAM_MAILBOX_OFFSET 512

// Sram mailbox entries. Word size is 32bit width.
#define SPI_DEVICE_PARAM_SRAM_MAILBOX_DEPTH 256

// Sram SFDP buffer offset (from egress buffer start). Word size is 32bit
// width.
#define SPI_DEVICE_PARAM_SRAM_SFDP_OFFSET 768

// Sram SFDP entries. Word size is 32bit width.
#define SPI_DEVICE_PARAM_SRAM_SFDP_DEPTH 64

// Sram TPM RdFIFO offset (from egress buffer start). Word size is 32bit
// width.
#define SPI_DEVICE_PARAM_SRAM_TPM_RD_FIFO_OFFSET 832

// Sram TPM RdFIFO entries. Word size is 32bit width.
#define SPI_DEVICE_PARAM_SRAM_TPM_RD_FIFO_DEPTH 16

// Sram payload FIFO offset (from ingress buffer start). Word size is 32bit
// width.
#define SPI_DEVICE_PARAM_SRAM_PAYLOAD_OFFSET 0

// Sram payload FIFO entries. Word size is 32bit width.
#define SPI_DEVICE_PARAM_SRAM_PAYLOAD_DEPTH 64

// Sram command FIFO offset (from ingress buffer start). Word size is 32bit
// width.
#define SPI_DEVICE_PARAM_SRAM_CMD_FIFO_OFFSET 64

// Sram command FIFO entries. Word size is 32bit width.
#define SPI_DEVICE_PARAM_SRAM_CMD_FIFO_DEPTH 16

// Sram address FIFO offset (from ingress buffer start). Word size is 32bit
// width.
#define SPI_DEVICE_PARAM_SRAM_ADDR_FIFO_OFFSET 80

// Sram address FIFO entries. Word size is 32bit width.
#define SPI_DEVICE_PARAM_SRAM_ADDR_FIFO_DEPTH 16

// Sram TPM Write FIFO offset (from ingress buffer start). Word size is 32bit
// width.
#define SPI_DEVICE_PARAM_SRAM_TPM_WR_FIFO_OFFSET 96

// Sram TPM Write FIFO entries. Word size is 32bit width.
...
#define SPI_DEVICE_CMD_INFO_0_READ_PIPELINE_MODE_0_FIELD \
  ((bitfield_field32_t) { .mask = SPI_DEVICE_CMD_INFO_0_READ_PIPELINE_MODE_0_MASK, .index = SPI_DEVICE_CMD_INFO_0_READ_PIPELINE_MODE_0_OFFSET })
#define SPI_DEVICE_CMD_INFO_0_READ_PIPELINE_MODE_0_VALUE_ZERO_STAGES 0x0
#define SPI_DEVICE_CMD_INFO_0_READ_PIPELINE_MODE_0_VALUE_TWO_STAGES_HALF_CYCLE \
  0x1
#define SPI_DEVICE_CMD_INFO_0_READ_PIPELINE_MODE_0_VALUE_TWO_STAGES_FULL_CYCLE \
  0x2
...
#define SPI_DEVICE_CMD_INFO_1_READ_PIPELINE_MODE_1_FIELD \
  ((bitfield_field32_t) { .mask = SPI_DEVICE_CMD_INFO_1_READ_PIPELINE_MODE_1_MASK, .index = SPI_DEVICE_CMD_INFO_1_READ_PIPELINE_MODE_1_OFFSET })
...
#define SPI_DEVICE_CMD_INFO_2_READ_PIPELINE_MODE_2_FIELD \
  ((bitfield_field32_t) { .mask = SPI_DEVICE_CMD_INFO_2_READ_PIPELINE_MODE_2_MASK, .index = SPI_DEVICE_CMD_INFO_2_READ_PIPELINE_MODE_2_OFFSET })
...
#define SPI_DEVICE_CMD_INFO_3_READ_PIPELINE_MODE_3_FIELD \
  ((bitfield_field32_t) { .mask = SPI_DEVICE_CMD_INFO_3_READ_PIPELINE_MODE_3_MASK, .index = SPI_DEVICE_CMD_INFO_3_READ_PIPELINE_MODE_3_OFFSET })
...
#define SPI_DEVICE_CMD_INFO_4_READ_PIPELINE_MODE_4_FIELD \
  ((bitfield_field32_t) { .mask = SPI_DEVICE_CMD_INFO_4_READ_PIPELINE_MODE_4_MASK, .index = SPI_DEVICE_CMD_INFO_4_READ_PIPELINE_MODE_4_OFFSET })
...
#define SPI_DEVICE_CMD_INFO_5_READ_PIPELINE_MODE_5_FIELD \
  ((bitfield_field32_t) { .mask = SPI_DEVICE_CMD_INFO_5_READ_PIPELINE_MODE_5_MASK, .index = SPI_DEVICE_CMD_INFO_5_READ_PIPELINE_MODE_5_OFFSET })
...
#define SPI_DEVICE_CMD_INFO_6_READ_PIPELINE_MODE_6_FIELD \
  ((bitfield_field32_t) { .mask = SPI_DEVICE_CMD_INFO_6_READ_PIPELINE_MODE_6_MASK, .index = SPI_DEVICE_CMD_INFO_6_READ_PIPELINE_MODE_6_OFFSET })
...
#define SPI_DEVICE_CMD_INFO_7_READ_PIPELINE_MODE_7_FIELD \
  ((bitfield_field32_t) { .mask = SPI_DEVICE_CMD_INFO_7_READ_PIPELINE_MODE_7_MASK, .index = SPI_DEVICE_CMD_INFO_7_READ_PIPELINE_MODE_7_OFFSET })
...
#define SPI_DEVICE_CMD_INFO_8_READ_PIPELINE_MODE_8_FIELD \
  ((bitfield_field32_t) { .mask = SPI_DEVICE_CMD_INFO_8_READ_PIPELINE_MODE_8_MASK, .index = SPI_DEVICE_CMD_INFO_8_READ_PIPELINE_MODE_8_OFFSET })
...
#define SPI_DEVICE_CMD_INFO_9_READ_PIPELINE_MODE_9_FIELD \
  ((bitfield_field32_t) { .mask = SPI_DEVICE_CMD_INFO_9_READ_PIPELINE_MODE_9_MASK, .index = SPI_DEVICE_CMD_INFO_9_READ_PIPELINE_MODE_9_OFFSET })
...
#define SPI_DEVICE_CMD_INFO_10_READ_PIPELINE_MODE_10_FIELD \
  ((bitfield_field32_t) { .mask = SPI_DEVICE_CMD_INFO_10_READ_PIPELINE_MODE_10_MASK, .index = SPI_DEVICE_CMD_INFO_10_READ_PIPELINE_MODE_10_OFFSET })
...
#define SPI_DEVICE_CMD_INFO_11_READ_PIPELINE_MODE_11_FIELD \
  ((bitfield_field32_t) { .mask = SPI_DEVICE_CMD_INFO_11_READ_PIPELINE_MODE_11_MASK, .index = SPI_DEVICE_CMD_INFO_11_READ_PIPELINE_MODE_11_OFFSET })
...
#define SPI_DEVICE_CMD_INFO_12_READ_PIPELINE_MODE_12_FIELD \
  ((bitfield_field32_t) { .mask = SPI_DEVICE_CMD_INFO_12_READ_PIPELINE_MODE_12_MASK, .index = SPI_DEVICE_CMD_INFO_12_READ_PIPELINE_MODE_12_OFFSET })
...
#define SPI_DEVICE_CMD_INFO_13_READ_PIPELINE_MODE_13_FIELD \
  ((bitfield_field32_t) { .mask = SPI_DEVICE_CMD_INFO_13_READ_PIPELINE_MODE_13_MASK, .index = SPI_DEVICE_CMD_INFO_13_READ_PIPELINE_MODE_13_OFFSET })
...
#define SPI_DEVICE_CMD_INFO_14_READ_PIPELINE_MODE_14_FIELD \
  ((bitfield_field32_t) { .mask = SPI_DEVICE_CMD_INFO_14_READ_PIPELINE_MODE_14_MASK, .index = SPI_DEVICE_CMD_INFO_14_READ_PIPELINE_MODE_14_OFFSET })
...
#define SPI_DEVICE_CMD_INFO_15_READ_PIPELINE_MODE_15_FIELD \
  ((bitfield_field32_t) { .mask = SPI_DEVICE_CMD_INFO_15_READ_PIPELINE_MODE_15_MASK, .index = SPI_DEVICE_CMD_INFO_15_READ_PIPELINE_MODE_15_OFFSET })
...
#define SPI_DEVICE_CMD_INFO_16_READ_PIPELINE_MODE_16_FIELD \
  ((bitfield_field32_t) { .mask = SPI_DEVICE_CMD_INFO_16_READ_PIPELINE_MODE_16_MASK, .index = SPI_DEVICE_CMD_INFO_16_READ_PIPELINE_MODE_16_OFFSET })
...
#define SPI_DEVICE_CMD_INFO_17_READ_PIPELINE_MODE_17_FIELD \
  ((bitfield_field32_t) { .mask = SPI_DEVICE_CMD_INFO_17_READ_PIPELINE_MODE_17_MASK, .index = SPI_DEVICE_CMD_INFO_17_READ_PIPELINE_MODE_17_OFFSET })
...
#define SPI_DEVICE_CMD_INFO_18_READ_PIPELINE_MODE_18_FIELD \
  ((bitfield_field32_t) { .mask = SPI_DEVICE_CMD_INFO_18_READ_PIPELINE_MODE_18_MASK, .index = SPI_DEVICE_CMD_INFO_18_READ_PIPELINE_MODE_18_OFFSET })
...
#define SPI_DEVICE_CMD_INFO_19_READ_PIPELINE_MODE_19_FIELD \
  ((bitfield_field32_t) { .mask = SPI_DEVICE_CMD_INFO_19_READ_PIPELINE_MODE_19_MASK, .index = SPI_DEVICE_CMD_INFO_19_READ_PIPELINE_MODE_19_OFFSET })
...
#define SPI_DEVICE_CMD_INFO_20_READ_PIPELINE_MODE_20_FIELD \
  ((bitfield_field32_t) { .mask = SPI_DEVICE_CMD_INFO_20_READ_PIPELINE_MODE_20_MASK, .index = SPI_DEVICE_CMD_INFO_20_READ_PIPELINE_MODE_20_OFFSET })
...
#define SPI_DEVICE_CMD_INFO_21_READ_PIPELINE_MODE_21_FIELD \
  ((bitfield_field32_t) { .mask = SPI_DEVICE_CMD_INFO_21_READ_PIPELINE_MODE_21_MASK, .index = SPI_DEVICE_CMD_INFO_21_READ_PIPELINE_MODE_21_OFFSET })
...
#define SPI_DEVICE_CMD_INFO_22_READ_PIPELINE_MODE_22_FIELD \
  ((bitfield_field32_t) { .mask = SPI_DEVICE_CMD_INFO_22_READ_PIPELINE_MODE_22_MASK, .index = SPI_DEVICE_CMD_INFO_22_READ_PIPELINE_MODE_22_OFFSET })
...
#define SPI_DEVICE_CMD_INFO_23_READ_PIPELINE_MODE_23_FIELD \
  ((bitfield_field32_t) { .mask = SPI_DEVICE_CMD_INFO_23_READ_PIPELINE_MODE_23_MASK, .index = SPI_DEVICE_CMD_INFO_23_READ_PIPELINE_MODE_23_OFFSET })
