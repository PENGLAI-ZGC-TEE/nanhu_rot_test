...
#define ENTROPY_SRC_PARAM_OBSERVE_FIFO_DEPTH 32
...
#define ENTROPY_SRC_CONF_REG_RESVAL 0x2649999u
...
#define ENTROPY_SRC_CONF_FIPS_FLAG_MASK 0xfu
#define ENTROPY_SRC_CONF_FIPS_FLAG_OFFSET 4
#define ENTROPY_SRC_CONF_FIPS_FLAG_FIELD \
  ((bitfield_field32_t) { .mask = ENTROPY_SRC_CONF_FIPS_FLAG_MASK, .index = ENTROPY_SRC_CONF_FIPS_FLAG_OFFSET })
#define ENTROPY_SRC_CONF_RNG_FIPS_MASK 0xfu
#define ENTROPY_SRC_CONF_RNG_FIPS_OFFSET 8
#define ENTROPY_SRC_CONF_RNG_FIPS_FIELD \
  ((bitfield_field32_t) { .mask = ENTROPY_SRC_CONF_RNG_FIPS_MASK, .index = ENTROPY_SRC_CONF_RNG_FIPS_OFFSET })
#define ENTROPY_SRC_CONF_RNG_BIT_ENABLE_MASK 0xfu
#define ENTROPY_SRC_CONF_RNG_BIT_ENABLE_OFFSET 12
...
#define ENTROPY_SRC_CONF_RNG_BIT_SEL_OFFSET 16
...
#define ENTROPY_SRC_CONF_THRESHOLD_SCOPE_OFFSET 18
...
#define ENTROPY_SRC_CONF_ENTROPY_DATA_REG_ENABLE_OFFSET 22
...
#define ENTROPY_SRC_OBSERVE_FIFO_THRESH_REG_RESVAL 0x10u
#define ENTROPY_SRC_OBSERVE_FIFO_THRESH_OBSERVE_FIFO_THRESH_MASK 0x3fu
...
#define ENTROPY_SRC_OBSERVE_FIFO_DEPTH_OBSERVE_FIFO_DEPTH_MASK 0x3fu
...
#define ENTROPY_SRC_DEBUG_STATUS_ENTROPY_FIFO_DEPTH_MASK 0x3u
...
#define ENTROPY_SRC_RECOV_ALERT_STS_FIPS_FLAG_FIELD_ALERT_BIT 17
#define ENTROPY_SRC_RECOV_ALERT_STS_RNG_FIPS_FIELD_ALERT_BIT 18
#define ENTROPY_SRC_RECOV_ALERT_STS_POSTHT_ENTROPY_DROP_ALERT_BIT 31
...
#define ENTROPY_SRC_ERR_CODE_SFIFO_DISTR_ERR_BIT 1
#define ENTROPY_SRC_ERR_CODE_SFIFO_OBSERVE_ERR_BIT 2
#define ENTROPY_SRC_ERR_CODE_SFIFO_ESFINAL_ERR_BIT 3
